...
(function(exports) {
  ...
  var audioNodeAudioBufferSourceNode = AudioNode;
  exports["AudioNode"] = AudioNode;
  exports["audioNodeAudioBufferSourceNode"] = audioNodeAudioBufferSourceNode;
...
(function(exports) {
  ...
  exports["startBufferSource"] = $foreign.startBufferSource;
})(PS["Audio.WebAudio.AudioBufferSourceNode"] = PS["Audio.WebAudio.AudioBufferSourceNode"] || {});
(function(exports) {
  /* jshint maxparams: false */
  /* global exports, XMLHttpRequest */
...
(function(exports) {
  ...
  var decodeAudioDataAsync = function (ctx) {
      return function ($0) {
          return Control_Monad_Aff_Compat.fromEffFnAff($foreign.decodeAudioDataAsyncImpl(ctx)($0));
      };
  };
...
(function(exports) {
  ...
  var playSoundAt = function (ctx) {
      return function (mbuffer) {
          return function (elapsedTime) {
              if (mbuffer instanceof Data_Maybe.Just) {
                  return function __do() {
                      var v = Audio_WebAudio_AudioContext.currentTime(ctx)();
                      var v1 = Audio_WebAudio_AudioContext.createBufferSource(ctx)();
                      var v2 = Audio_WebAudio_AudioContext.destination(ctx)();
                      var v3 = Audio_WebAudio_AudioContext.connect(Audio_WebAudio_Types.audioNodeAudioBufferSourceNode)(Audio_WebAudio_Types.audioNodeDestinationNode)(v1)(v2)();
                      var v4 = Audio_WebAudio_AudioBufferSourceNode.setBuffer(mbuffer.value0)(v1)();
                      return Audio_WebAudio_AudioBufferSourceNode.startBufferSource(v + elapsedTime + 0.1)(v1)();
                  };
              };
  ...
  var loadSoundBuffer = function (ctx) {
      return function (fileName) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableArrayBuffer)((function () {
              var $21 = {};
              ...
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Audio_WebAudio_AudioContext.decodeAudioDataAsync(ctx)(v.response))(function (v1) {
  ...
  var loadSoundBuffers = function (ctx) {
      return function (fileNames) {
          return Control_Parallel_Class.sequential(Control_Monad_Aff.parallelAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeParAff)(function (name) {
              return Control_Parallel_Class.parallel(Control_Monad_Aff.parallelAff)(loadSoundBuffer(ctx)(name));
          })(fileNames));
      };
  };
  exports["loadSoundBuffer"] = loadSoundBuffer;
  exports["loadSoundBuffers"] = loadSoundBuffers;
  exports["playSoundAt"] = playSoundAt;
})(PS["Audio.Util"] = PS["Audio.Util"] || {});
(function(exports) {
    "use strict";
  var Audio_Util = PS["Audio.Util"];
  var Audio_WebAudio_AudioContext = PS["Audio.WebAudio.AudioContext"];
  var Audio_WebAudio_Types = PS["Audio.WebAudio.Types"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  ...
  var playLoopPattern = function (ctx) {
      return function (buffer) {
          return function (time) {
              return function (eighthNoteTime) {
                  return function (count) {
                      var $9 = count > 0;
                      if ($9) {
                          return function __do() {
                              var v = Audio_Util.playSoundAt(ctx)(buffer)(time + Data_Int.toNumber(count) * eighthNoteTime)();
                              return playLoopPattern(ctx)(buffer)(time)(eighthNoteTime)(count - 1 | 0)();
                          };
                      };
                      return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                  };
  ...
  var aBar = function (ctx) {
      return function (buffers) {
          return function (bar) {
              var snare = Data_Array.index(buffers)(2);
              var kick = Data_Array.index(buffers)(1);
              var hihat = Data_Array.index(buffers)(0);
            
              // BPM (beats per minute)
  var eighthNoteTime = Data_Int.toNumber(60) / Data_Int.toNumber(80) / 2.0;
              var time = Data_Int.toNumber(bar) * 8.0 * eighthNoteTime;
              return function __do() {
                  var v = Audio_Util.playSoundAt(ctx)(kick)(time)();
                  var v1 = Audio_Util.playSoundAt(ctx)(kick)(time + 4.0 * eighthNoteTime)();
                  var v2 = Audio_Util.playSoundAt(ctx)(snare)(time + 2.0 * eighthNoteTime)();
                  var v3 = Audio_Util.playSoundAt(ctx)(snare)(time + 6.0 * eighthNoteTime)();
                  return playLoopPattern(ctx)(hihat)(time)(eighthNoteTime)(8)();
              };
          };
      };
  };
  var example = Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Audio_WebAudio_AudioContext.makeAudioContext))(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Audio_Util.loadSoundBuffers(v)([ "wav/hihat.wav", "wav/kick.wav", "wav/snare.wav" ]))(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(aBar(v)(v1)(0)))(function (v2) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(aBar(v)(v1)(1)))(function (v3) {
  ...
  exports["aBar"] = aBar;
  exports["playLoopPattern"] = playLoopPattern;
  exports["example"] = example;
})(PS["Audio.Example.Rhythm"] = PS["Audio.Example.Rhythm"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Audio_Example_Rhythm = PS["Audio.Example.Rhythm"];
  var Audio_WebAudio_Types = PS["Audio.WebAudio.Types"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Network_HTTP_Affjax = PS["Network.HTTP.Affjax"];
  var Prelude = PS["Prelude"];        
  var main = Control_Monad_Aff.launchAff(Audio_Example_Rhythm.example);
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
